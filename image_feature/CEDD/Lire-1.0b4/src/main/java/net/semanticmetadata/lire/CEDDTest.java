...
public class CEDDTest {
    public static void main(String[] args) throws IOException, IllegalAccessException, InstantiationException {
        int i =1;
        while (i <= 20){
            String path = "E:\\TRP\\data\\reports\\" + String.valueOf(i) +
            ...
            for(int j = 0; j < indexes.size(); j++){
                ...
                String imagePath = "E:\\TRP\\data\\reports\\"  + String.valueOf(i) + "\\images\\"+index + "." + url_type;
                ...
                String Path1 = "E:\\TRP\\output\\"  + String.valueOf(i) + "\\EdgeHistogram.txt";
                String Path2 = "E:\\TRP\\output\\"  + String.valueOf(i) + "\\ColorLayout.txt";
                String Path3 = "E:\\TRP\\output\\"  + String.valueOf(i) + "\\ScalableColor.txt";
                String Path4 = "E:\\TRP\\output\\"  + String.valueOf(i) + "\\CEDD.txt";
                BufferedWriter bw;
