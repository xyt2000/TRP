...
public class ScalableColorTest extends TestCase {
    ...
    public static void main(String[] args) throws IOException, IllegalAccessException, InstantiationException {
        ...
        String testFilesPath = "E:\\python-img_gist_feature-master\\test";
        ...
        for (int i = 0; i < results.size(); i++) {
            ...
            sch.extract(image);
            System.out.println(results.get(i) + "\t" + Arrays.toString(sch.getFeatureVector()));
            System.out.println(sch.getFeatureVector().length);
        }
    }/*
